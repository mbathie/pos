...
async function validateDiscount(discount, customer, cart) {
  ...
  if (discount.musts) {
    ...
    if (mustHaveProducts.length > 0 || mustHaveCategories.length > 0) {
      ...
      // If not in cart and customer is provided, check for membership products or categories
      if (!hasRequiredItems && customer && (mustHaveProducts.length > 0 || mustHaveCategories.length > 0)) {
