...
export function prepareCartForTransaction(cart) {
  // Use the removeKeys utility with default keys
  // This will remove: timesCalc, desc, createdAt, updatedAt, thumbnail, 
  // __v, deleted, instructions, modGroups, modGroupsData, waiver, variations
  return removeKeys(cart);
}
